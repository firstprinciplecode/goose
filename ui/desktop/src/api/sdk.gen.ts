...
export const importSessionMessages = <ThrowOnError extends boolean = false>(options: Options<ImportSessionMessagesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ImportSessionMessagesResponses, ImportSessionMessagesErrors, ThrowOnError>({
